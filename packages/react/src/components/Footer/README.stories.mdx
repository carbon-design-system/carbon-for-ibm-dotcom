...
> 💡 Check our
> [CodeSandbox](https://githubbox.com/carbon-design-system/carbon-for-ibm-dotcom/tree/v1/packages/react/examples/codesandbox/components/Footer)
> example implementation.

[![Edit @carbon/ibmdotcom-web-components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://githubbox.com/carbon-design-system/carbon-for-ibm-dotcom/tree/v1/packages/react/examples/codesandbox/components/Footer)
...
- [Default](https://github.com/carbon-design-system/carbon-for-ibm-dotcom/blob/v1/packages/react/src/components/Footer/__data__/footer-menu.json)
- [Short](https://github.com/carbon-design-system/carbon-for-ibm-dotcom/blob/v1/packages/react/src/components/Footer/__data__/footer-thin.json)
...
> See
> [.env.example](https://github.com/carbon-design-system/carbon-for-ibm-dotcom/blob/v1/packages/react/.env.example)
