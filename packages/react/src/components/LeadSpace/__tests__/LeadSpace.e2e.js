...
describe('LeadSpace | short', () => {
  it('should load the g100 theme', () => {
    cy.visit(`${_host}/${_pathShort}&theme=g100`);
    cy.viewport(1280, 780);
    ...
    cy.window().then(win => {
      ...
      cy.screenshot();
      // Take a snapshot for visual diffing
      cy.percySnapshot('LeadSpace | short | g100 theme', {
        widths: [1280],
      });
    });
  });
  ...
  it('should load the g90 theme', () => {
    cy.visit(`${_host}/${_pathShort}&theme=g90`);
    cy.viewport(1280, 780);
    ...
    cy.window().then(win => {
      ...
      cy.screenshot();
      // Take a snapshot for visual diffing
      cy.percySnapshot('LeadSpace | short | g90 theme', {
        widths: [1280],
      });
    });
  });
  ...
  it('should load the g10 theme', () => {
    cy.visit(`${_host}/${_pathShort}&theme=g10`);
    cy.viewport(1280, 780);
    ...
    cy.window().then(win => {
      ...
      cy.screenshot();
      // Take a snapshot for visual diffing
      cy.percySnapshot('LeadSpace | short | g10 theme', {
        widths: [1280],
      });
    });
  });
...
describe('LeadSpace | short with image', () => {
  it('should load the g100 theme', () => {
    cy.visit(`${_host}/${_pathShortWithImage}&theme=g100`);
    cy.viewport(1280, 780);
    ...
    cy.window().then(win => {
      ...
      cy.screenshot();
      // Take a snapshot for visual diffing
      cy.percySnapshot('LeadSpace | short with image | g100 theme', {
        widths: [1280],
      });
    });
  });
  ...
  it('should load the g90 theme', () => {
    cy.visit(`${_host}/${_pathShortWithImage}&theme=g90`);
    cy.viewport(1280, 780);
    ...
    cy.window().then(win => {
      ...
      cy.screenshot();
      // Take a snapshot for visual diffing
      cy.percySnapshot('LeadSpace | short with image | g90 theme', {
        widths: [1280],
      });
    });
  });
  ...
  it('should load the g10 theme', () => {
    cy.visit(`${_host}/${_pathShortWithImage}&theme=g10`);
    cy.viewport(1280, 780);
    ...
    cy.window().then(win => {
      ...
      cy.screenshot();
      // Take a snapshot for visual diffing
      cy.percySnapshot('LeadSpace | short with image | g10 theme', {
        widths: [1280],
      });
    });
  });
