        ...
        <div className="video-background">
          <video autoPlay="autoplay" muted>
            <source type="video/webm"
              ...
              />
            { bandData.content[locale ? locale : 'en'].videoUrl2 && <source type="video/mp4" src={bandData.content[locale ? locale : 'en'].videoUrl2} /> }
          </video>
        </div>;
      }
    return (
      <div id="think-banner-container">
        <a id="think-banner-link" className="ibm-blocklink ibm-alternate-background" href={bandData.content[locale ? locale : 'en'].ctaUrl}>
          <div id="think-banner-content">
            <div className="ibm-columns bx--grid ibm-padding-bottom-0">
              <div id="think-banner-desktop">
                { videoString }
                <div className="flex align-center think-counter__container">
                  <div>
                    <span className="ibm-bold ibm-h4-small counter-text" dangerouslySetInnerHTML={{ __html: `${bandData.content[locale ? locale : 'en'].bannerTextLive1} <br/>${bandData.content[locale ? locale : 'en'].bannerTextLive2}`}}>
                    </span>
                  </div>
                </div>
