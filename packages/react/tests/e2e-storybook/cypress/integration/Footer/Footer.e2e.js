...
describe('dds-footer | Short (desktop)', () => {
  ...
  it('should open locale modal with 4 geos when clicked on locale button', () => {
    ...
    cy.percySnapshot(
      'dds-footer | Short | open locale modal with 4 geos when clicked on locale button',
      {
        widths: [1280],
      }
    );
  ...
  it('should display the specific locations and languages of a selected geo', () => {
    ...
    cy.percySnapshot(
      'dds-footer | Short | display the specific locations and languages of a selected geo',
      {
        widths: [1280],
      }
    );
  ...
  it('should display interactive search field and with keywords for locations and languages', () => {
    ...
    cy.percySnapshot(
      'dds-footer | Short | display interactive search field and with keywords for locations and languages',
      {
        widths: [1280],
      }
    );
  ...
  it('should load footer legal navigation with clickable links', () => {
    ...
    cy.percySnapshot(
      'dds-footer | Short | load footer legal navigation with clickable links',
      {
        widths: [1280],
      }
    );
