 ...
 * @private
 */
const _pathDefault = '/iframe.html?id=components-quote--default';
...
describe('Quote', () => {
  ...
  it('should load g100 theme', async () => {
    ...
    await percySnapshot(page, 'Components|Quote: g100 theme', {
      widths: [320, 1280],
    });
  });
  ...
  it('should load g90 theme', async () => {
    ...
    await percySnapshot(page, 'Components|Quote: g90 theme', {
      widths: [320, 1280],
    });
  });
  ...
  it('should load g10 theme', async () => {
    ...
    await percySnapshot(page, 'Components|Quote: g10 theme', {
      widths: [320, 1280],
    });
  });
});
