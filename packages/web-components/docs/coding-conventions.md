...
```typescript
...
import HostListener from '@carbon/carbon-web-components/es/globals/decorators/HostListener.js';
import HostListenerMixin from '@carbon/carbon-web-components/es/globals/mixins/HostListener.js';
...
