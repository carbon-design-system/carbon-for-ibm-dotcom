...
describe('c4d-pictogram-item | Pictogram item (desktop)', () => {
  ...
  it('should load pictogram item and content', () => {
    ...
    cy.get('[data-autoid="c4d--pictogram-item"]').should('have.length', 1);
    cy.get(
      '[data-autoid="c4d--pictogram-item"] [data-autoid="c4d--pictogram-item__pictogram"]'
    ).should('have.length', 1);
    cy.get(
      '[data-autoid="c4d--pictogram-item"] [data-autoid="c4d--content-item__heading"]'
    ).should('have.length', 1);
  ...
  it('should check that the Link with icon is loaded and clickable', () => {
    ...
    const linkWithIcon = cy.get(
      '[data-autoid="c4d--pictogram-item"] [data-autoid="c4d--link-with-icon"]'
    );
...
describe('c4d-pictogram-item | Pictogram item (mobile)', () => {
  it('should load pictogram item and content', () => {
    cy.visit(`/${_pathDefault}`);
    cy.viewport(320, 780);
    cy.get('[data-autoid="c4d--pictogram-item"]').should('have.length', 1);
