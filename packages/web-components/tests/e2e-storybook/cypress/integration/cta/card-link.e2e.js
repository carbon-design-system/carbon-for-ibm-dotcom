...
const _path = {
  ...
  local: 'iframe.html?id=components-cta--card-link&knob-CTA%20type%20(cta-type)_CardCTA=local',
  jump: 'iframe.html?id=components-cta--card-link&knob-CTA%20type%20(cta-type)_CardCTA=jump',
  external: 'iframe.html?id=components-cta--card-link&knob-CTA%20type%20(cta-type)_CardCTA=external',
  download: 'iframe.html?id=components-cta--card-link&knob-CTA%20type%20(cta-type)_CardCTA=download',
  video: 'iframe.html?id=components-cta--card-link&knob-CTA%20type%20(cta-type)_CardCTA=video',
};
