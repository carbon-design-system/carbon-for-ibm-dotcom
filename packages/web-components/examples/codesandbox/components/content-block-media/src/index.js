...
import '@carbon/ibmdotcom-web-components/es/components/content-block-media/content-block-media';
...
import '@carbon/ibmdotcom-web-components/es/components/content-block-media/content-block-media-content';
