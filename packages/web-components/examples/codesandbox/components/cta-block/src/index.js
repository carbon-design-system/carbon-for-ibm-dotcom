...
import '@carbon/ibmdotcom-web-components/es/components/cta-block/cta-block';
import '@carbon/ibmdotcom-web-components/es/components/cta-block/cta-block-item-row';
import '@carbon/ibmdotcom-web-components/es/components/cta-block/cta-block-item';
