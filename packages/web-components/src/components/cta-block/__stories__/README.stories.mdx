...
<dds-cta-block no-border>
  <dds-content-block-heading
    >C4D Content Block Heading</dds-content-block-heading
  >
  <dds-content-block-copy>C4D Content Block Copy</dds-content-block-copy>
  ...
  <dds-cta-block-item-row>
    <dds-cta-block-item>
      ...
      <dds-content-item-copy
        ...
        that right solution for you.</dds-content-item-copy
      >
      <dds-text-cta
        slot="footer"
        cta-type="local"
    ...
    <dds-cta-block-item>
      ...
      <dds-content-item-copy
        ...
        methodologies.</dds-content-item-copy
      >
      <dds-text-cta
        slot="footer"
        cta-type="local"
...
<dds-cta-block>
  ...
  <dds-link-list slot="link-list" type="end">
    ...
    <dds-link-list-item href="https://example.com"> Events </dds-link-list-item>
    <dds-link-list-item href="https://example.com"> Blogs </dds-link-list-item>
    ...
    <dds-link-list-item href="https://example.com"> News </dds-link-list-item>
  </dds-link-list>
</dds-cta-block>
```
