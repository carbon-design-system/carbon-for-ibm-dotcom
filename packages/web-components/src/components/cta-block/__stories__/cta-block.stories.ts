...
import { DDS_CTA_BLOCK } from '../../../globals/internal/feature-flags';
...
export const Default = !DDS_CTA_BLOCK
  ? undefined
  : ({ parameters }) => {
      ...
      parameters: {
        ...
        knobs: {
          CtaBlock: ({ groupId }) => ({
            ...
            supportingElement: select(
              'Supporting Element',
              ['image', 'video', 'pictogram', 'statistic', 'none'],
              'image',
              groupId
            ),
          }),
