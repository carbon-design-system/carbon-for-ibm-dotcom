...
[![Edit @carbon/ibmdotcom-web-components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://stackblitz.com/github/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/web-components/examples/codesandbox/components/logo-grid)
...
| ----------------------- | ----------------------------------- | ------------------------------- |
| `<c4d-logo-grid>`       | `data-autoid="cds--logo-grid"`      | Logo Grid main component        |
| `<c4d-logo-link>`       | `data-autoid="cds--logo-grid-link"` | Logo Grid bottom link component |
| `<c4d-logo-item>`       | `data-autoid="cds--logo-grid-item"` | Logo Grid item component        |
