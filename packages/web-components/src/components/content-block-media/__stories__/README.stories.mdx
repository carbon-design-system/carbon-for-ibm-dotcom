...
[![Edit @carbon/ibmdotcom-web-components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://stackblitz.com/github/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/web-components/examples/codesandbox/components/content-block-media)
...
<c4d-content-block-media complementary-style-scheme="${ifDefined(complementaryStyleScheme)}">
    ...
    <c4d-content-block-media-content>
      ...
      <c4d-card-link-cta slot="footer" href="https://example.com" cta-type="local">
        <c4d-card-link-heading>Lorem ipsum dolor sit amet</c4d-card-link-heading>
        <c4d-card-footer></c4d-card-footer>
      </c4d-card-link>
    </c4d-content-block-media-content>
