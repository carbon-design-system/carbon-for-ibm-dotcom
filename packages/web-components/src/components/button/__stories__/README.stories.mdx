...
This component extends from [Carbon Web Component button](https://web-components.carbondesignsystem.com/?path=/docs/components-button--default).
...
```html
<dds-button href="https://example.com">Example</dds-button>
```
...
* The Button component will need to be wrapped within a `dds-video-cta-container` components for videos to play.
