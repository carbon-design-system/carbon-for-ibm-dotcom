...
/**
 * The heading content of card base class.
 */
export class DDSCardHeadingBase extends StableSelectorMixin(LitElement) {
  /**
...
class DDSCardHeading extends DDSCardHeadingBase {}
