...
/**
 * The Content Section base class for use with cardSection.
 */
export class DDSContentSectionBase extends StableSelectorMixin(LitElement) {
  /**
...
class DDSContentSection extends DDSContentSectionBase {}
