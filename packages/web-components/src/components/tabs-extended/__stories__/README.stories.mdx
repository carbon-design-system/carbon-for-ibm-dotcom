...
[![Edit @carbon/ibmdotcom-web-components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://stackblitz.com/github/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/web-components/examples/codesandbox/components/tabs-extended)
...
| ----------------------- | ---------------------------------- | ----------- |
| `<c4d-tabs-extended>`   | `data-autoid="cds--tabs-extended"` | Component   |
| `<c4d-tab>`             | `data-autoid="cds--tab"`           | Component   |
