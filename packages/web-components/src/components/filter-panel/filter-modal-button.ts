...
import { BXModalFooterButtonBase } from '@carbon/web-components/es/components/modal/modal-footer-button.js';
...
class DDSFilterModalButton extends StableSelectorMixin(
  BXModalFooterButtonBase
) {
