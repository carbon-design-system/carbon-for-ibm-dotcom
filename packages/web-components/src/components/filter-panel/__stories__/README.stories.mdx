...
[![Edit @carbon/ibmdotcom-web-components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://stackblitz.com/github/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/web-components/examples/codesandbox/components/filter-panel)
...
<c4d-filter-panel-composite>
  ...
  <c4d-filter-group>
    <c4d-filter-group-item title-text="Product types">
...
| ------------------------------ | ------------------------------------------- | ----------- |
| `<c4d-filter-panel>`           | `data-autoid="cds--filter-panel"`           | Component   |
| `<c4d-filter-panel-modal>`     | `data-autoid="cds--filter-panel-modal"`     | Component   |
| `<c4d-filter-panel-composite>` | `data-autoid="cds--filter-panel-composite"` | Component   |
