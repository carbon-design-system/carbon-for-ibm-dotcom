...
/**
 * Feature card footer base class.
 */
export class DDSFeatureCardFooterBase extends DDSCardFooterBase {
  updated() {
    super.updated();
...
class DDSFeatureCardFooter extends DDSFeatureCardFooterBase {}
