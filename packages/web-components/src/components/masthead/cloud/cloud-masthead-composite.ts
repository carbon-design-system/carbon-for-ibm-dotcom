...
/**
 * EXPERIMENTAL: Cloud Mathead Composite
 *
...
if (DDS_CLOUD_MASTHEAD) {
  customElements.define(`${ddsPrefix}-cloud-masthead-composite`, DDSCloudMastheadComposite);
}

export default !DDS_CLOUD_MASTHEAD ? undefined : DDSCloudMastheadComposite;
