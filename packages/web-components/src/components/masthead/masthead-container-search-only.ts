 ...
 */
export interface MastheadContainerSearchOnlyState extends MastheadSearchContainerState {
  /**
 ...
 */
export function mapStateToProps(state: MastheadContainerSearchOnlyState) {
...
class DDSMastheadContainerSearchOnly extends ConnectMixin<MastheadContainerSearchOnlyState, SearchAPIActions>(
  store as Store<MastheadContainerSearchOnlyState, SearchAPIActions>,
  mapStateToProps,
  mapDispatchToProps
