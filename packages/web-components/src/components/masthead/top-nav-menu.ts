...
import { BXHeaderMenuBase } from '@carbon/web-components/es/components/ui-shell/header-menu.js';
...
/**
 * Masthead top nav submenu base class.
 */
export class DDSTopNavMenuBase extends BXHeaderMenuBase {
  /**
   * The trigger button.
   */
  @query('[part="trigger"]')
...
class DDSTopNavMenu extends DDSTopNavMenuBase {}
