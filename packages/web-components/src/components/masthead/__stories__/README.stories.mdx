...
`navLinks` property of the masthead-composite component. This property should be
an array of `L0MenuItem` objects as defined in
...
```html
<c4d-masthead-composite id="masthead"></c4d-masthead-composite>
```
