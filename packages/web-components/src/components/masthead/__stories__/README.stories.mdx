...
[![Edit carbon-custom-elements](https://codesandbox.io/static/img/play-codesandbox.svg)](https://githubbox.com/carbon-design-system/ibm-dotcom-library/tree/master/packages/web-components/examples/codesandbox/components/masthead)
...
```javascript
import '@carbon/ibmdotcom-webcomponents/es/components/masthead/masthead-container';
```
