...
#### Setting Platform and URL

```html
<dds-masthead-container platform="Lorem Ipsum" platform-url="https://www.example.com"></dds-masthead-container>
```

#### Setting Platform URL Object (Optional)
...
const urlObject = {
  ...
  'es-MX': {
    url: 'https://www.example.com/sample/es-mx',
  },
};
```

```html
<dds-masthead-container platform="Lorem Ipsum" platformObj={urlObject}></dds-masthead-container>
```
