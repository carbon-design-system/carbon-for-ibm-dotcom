...
```html
<cds-masthead-container platform="Lorem Ipsum"></cds-masthead-container>
```
...
<cds-masthead-container
  ...
  id="masthead-container"></cds-masthead-container>
```
...
To use L1 nav, set `l1Data` prop. `l1Data` prop should be a MastheadL1
object, as defined in packages/services-store/src/actions/translateAPI.ts
that contains the navigation data of L1 nav:
...
```html
<cds-masthead-container
  data-endpoint="/custom-endpoint"></cds-masthead-container>
```
...
```html
<cds-masthead-container custom-typeahead-api="true"></cds-masthead-container>
```
...
<cds-masthead-composite
  .scopeParameters="${scopeParameters}"></cds-masthead-composite>
```
...
### `<cds-masthead-container>`/`<cds-masthead-composite>`

<Props of="cds-masthead-composite" />

For Cloud-specific version of masthead-container,
`<cds-cloud-masthead-container>`, we support two user authentication methods,
via cookie or api. To select between the two, provide the `auth-method` prop
with a value of either 'cookie' or 'api'.

```html
<cds-cloud-masthead-container
  auth-method="cookie"></cds-cloud-masthead-container>
```
...
| ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ | ----------- |
| `<cds-masthead>`                                                                          | `data-autoid="cds--masthead"`                                            | Component   |
| `<cds-masthead-menu-button>`                                                              | `data-autoid="cds--masthead__hamburger"`                                 | Interactive |
| `<cds-top-nav-name>`                                                                      | `data-autoid="cds--masthead__platform-name"`                             | Interactive |
| `<cds-top-nav>`                                                                           | `data-autoid="cds--masthead__l0-nav"`                                    | Component   |
| `<cds-top-nav-menu trigger-content="${item}">` and `<cds-top-nav-item title="${item}">`   | `data-autoid="cds--masthead__l0-nav--nav${item}"`                        | Interactive |
| `<cds-top-nav-menu-item title="${item}">`                                                 | `data-autoid="cds--masthead__l0-nav--subnav-col${item}-item${item}"`     | Interactive |
| `<cds-left-nav>`                                                                          | `data-autoid="cds--masthead__l0-sidenav"`                                | Component   |
| `<cds-left-nav-menu trigger-content="${item}">` and `<cds-left-nav-item title="${item}">` | `data-autoid="cds--masthead__l0-sidenav--nav${item}"`                    | Interactive |
| `<cds-left-nav-menu-item title="${item}">`                                                | `data-autoid="cds--masthead__l0-sidenav--subnav-col${item}-item${item}"` | Interactive |
