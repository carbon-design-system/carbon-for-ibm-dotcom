...
> 💡 Check our
> [CodeSandbox](https://githubbox.com/carbon-design-system/carbon-for-ibm-dotcom/tree/v1/packages/web-components/examples/codesandbox/components-react/masthead)
> example implementation.

### Masthead (L0):

[![Edit @carbon/ibmdotcom-web-components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://githubbox.com/carbon-design-system/carbon-for-ibm-dotcom/tree/v1/packages/web-components/examples/codesandbox/components-react/masthead)

### Masthead (L1):

[![Edit @carbon/ibmdotcom-web-components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://githubbox.com/carbon-design-system/carbon-for-ibm-dotcom/tree/v1/packages/web-components/examples/codesandbox/components-react/masthead-l1)
...
function App() {
  return <DDSMastheadContainer></DDSMastheadContainer>;
}
```
...
```javascript
function App() {
  return <DDSMastheadContainer platform="Lorem ipsum"></DDSMastheadContainer>;
}
```
...
function App() {
  return (
    <DDSMastheadContainer
      ...
      id="masthead-container"></DDSMastheadContainer>
  );
}
```
...
```javascript
function App() {
  return <DDSMastheadContainer id="masthead-container"></DDSMastheadContainer>;
}
```
...
```javascript
function App() {
  return <DDSMastheadContainer auth-method="cookie"></DDSMastheadContainer>;
}
```
