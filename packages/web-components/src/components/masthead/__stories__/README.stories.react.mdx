...
> 💡 Check our
> [CodeSandbox](https://stackblitz.com/github/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/web-components/examples/codesandbox/components-react/masthead)
> example implementation.

### Masthead (L0):

[![Edit @carbon/ibmdotcom-web-components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://stackblitz.com/github/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/web-components/examples/codesandbox/components-react/masthead)

### Masthead (L1):

[![Edit @carbon/ibmdotcom-web-components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://stackblitz.com/github/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/web-components/examples/codesandbox/components-react/masthead-l1)
...
| ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ | ----------- |
| `<c4d-masthead>`                                                                          | `data-autoid="cds--masthead"`                                            | Component   |
| `<c4d-masthead-menu-button>`                                                              | `data-autoid="cds--masthead__hamburger"`                                 | Interactive |
| `<c4d-top-nav-name>`                                                                      | `data-autoid="cds--masthead__platform-name"`                             | Interactive |
| `<c4d-top-nav>`                                                                           | `data-autoid="cds--masthead__l0-nav"`                                    | Component   |
| `<c4d-top-nav-menu trigger-content="${item}">` and `<c4d-top-nav-item title="${item}">`   | `data-autoid="cds--masthead__l0-nav--nav${item}"`                        | Interactive |
| `<c4d-top-nav-menu-item title="${item}">`                                                 | `data-autoid="cds--masthead__l0-nav--subnav-col${item}-item${item}"`     | Interactive |
| `<c4d-left-nav>`                                                                          | `data-autoid="cds--masthead__l0-sidenav"`                                | Component   |
| `<c4d-left-nav-menu trigger-content="${item}">` and `<c4d-left-nav-item title="${item}">` | `data-autoid="cds--masthead__l0-sidenav--nav${item}"`                    | Interactive |
| `<c4d-left-nav-menu-item title="${item}">`                                                | `data-autoid="cds--masthead__l0-sidenav--subnav-col${item}-item${item}"` | Interactive |
