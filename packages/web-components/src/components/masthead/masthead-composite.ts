...
/**
 * Base class that renders masthead from links, etc. data.
 */
export class DDSMastheadCompositeBase extends LitElement {
  /**
...
class DDSMastheadComposite extends DDSMastheadCompositeBase {}
