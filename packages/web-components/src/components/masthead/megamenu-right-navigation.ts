...
/**
 * MegaMenu right navigation section base class.
 */
export class DDSMegaMenuRightNavigationBase extends LitElement {
  /**
...
class DDSMegaMenuRightNavigation extends DDSMegaMenuRightNavigationBase {}
