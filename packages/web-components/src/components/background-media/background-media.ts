...
import pauseIcon from '@carbon/carbon-web-components/es/icons/pause--outline--filled/32.js';
import playIcon from '@carbon/carbon-web-components/es/icons/play--filled/32.js';
