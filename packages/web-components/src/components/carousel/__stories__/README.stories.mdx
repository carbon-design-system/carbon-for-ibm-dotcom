...
import '@carbon/ibmdotcom-web-components/es/components/content-section/content-section-copy.js';
```
...
<dds-carousel>
  <dds-content-section-leading>
    ...
    <dds-link-with-icon slot="footer" href="https://www.ibm.com/standards/web/carbon-for-ibm-dotcom">
      Link text
      <svg
        slot="icon"
        focusable="false"
