...
> 💡 Check our
> [CodeSandbox](https://githubbox.com/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/web-components/examples/codesandbox/components-react/in-page-banner)
> example implementation.

[![Edit @carbon/ibmdotcom-web-components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://githubbox.com/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/web-components/examples/codesandbox/components-react/in-page-banner)
...
import C4DLinkListItem from '@carbon/ibmdotcom-web-components/es/components-react/cta/link-list-item';
...
| ----------------------- | ---------------------- | ----------- |
| `<cds-in-page-banner>`  | N/A                    | Component   |
