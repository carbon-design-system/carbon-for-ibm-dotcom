...
>
> 💡 Check our
> [CodeSandbox](https://stackblitz.com/github/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/web-components/examples/codesandbox/components-react/content-group-pictograms)
> example implementation.

[![Edit @carbon/ibmdotcom-web-components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://stackblitz.com/github/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/web-components/examples/codesandbox/components-react/content-group-pictograms)
...
| -------------------------------- | --------------------------------------------- | ----------- |
| `<c4d-content-group-pictograms>` | `data-autoid="cds--content-group-pictograms"` | Component   |
| `<c4d-content-group-heading>`    | `data-autoid="cds--content-group__heading"`   | Component   |
| `<c4d-content-group-copy>`       | `data-autoid="cds--content-group__copy"`      | Component   |
| `<c4d-pictogram-item>`           | `data-autoid="cds--pictogram-item"`           | Component   |
...
| `<c4d-link-with-icon>`           | `data-autoid="cds--link-with-icon"`           | Component   |
