...
| -------------------------------- | --------------------------------------------- | ----------- |
| `<cds-content-group-pictograms>` | `data-autoid="cds--content-group-pictograms"` | Component   |
| `<cds-content-group-heading>`    | `data-autoid="cds--content-group__heading"`   | Component   |
| `<cds-content-group-copy>`       | `data-autoid="cds--content-group__copy"`      | Component   |
| `<cds-pictogram-item>`           | `data-autoid="cds--pictogram-item"`           | Component   |
...
| `<cds-link-with-icon>`           | `data-autoid="cds--link-with-icon"`           | Component   |
