...
> The Promo Group - is a collection of simple promo text items presented in a section with a left-column header that provides different variants for showcasing images, statistics, and pictograms content.
...
import '@carbon/ibmdotcom-web-components/es/components/promo-group/promo-group.js';
...
```html
<dds-promo-group color-scheme="inverse">
  <dds-content-section-heading>Title heading</dds-content-section-heading>
  ...
  <dds-card-group slot="group-items">
    <dds-promo-item color-scheme="inverse">
      <dds-card-heading>End-to-end IT management</dds-card-heading>
      <dds-content-item-copy slot="copy">
        Manage and orchestrate your hybrid multicloud infrastructure with the most secure, reliable and flexible servers available today.
