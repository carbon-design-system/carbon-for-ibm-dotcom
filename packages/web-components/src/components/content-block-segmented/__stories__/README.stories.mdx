...
[![Edit @carbon/ibmdotcom-web-components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://stackblitz.com/github/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/web-components/examples/codesandbox/components/content-block-segmented)
...
<c4d-content-block-segmented>
  ...
  <c4d-card-link-cta slot="footer" cta-type="local" href="https://example.com">
...
<c4d-content-block-segmented complementary-style-scheme="with-border">
  ...
  <c4d-card-link-cta slot="footer" cta-type="local" href="https://www.ibm.com/">
    <c4d-card-link-heading>Lorem ipsum dolor</c4d-card-link-heading>
    <c4d-card-footer></c4d-card-footer>
  </c4d-card-link-cta>
</c4d-content-block-segmented>
...
<c4d-content-block-segmented complementary-style-scheme="with-border">
  ...
  <c4d-link-list type="default" slot="complementary">
    ...
    <c4d-link-list-item-card href="https://example.com" cta-type="local">
      <p>Containerization A Complete Guide</p>
      <c4d-card-footer></c4d-card-footer>
    </c4d-link-list-item-card>
    <c4d-link-list-item-card href="https://example.com" cta-type="external">
...
| ------------------------------------ | ------------------------------------------------- | ----------- |
| `<c4d-content-block-segmented>`      | `data-autoid="cds--content-block-segmented"`      | Component   |
| `<c4d-content-block-segmented-item>` | `data-autoid="cds--content-block-segmented-item"` | Component   |
