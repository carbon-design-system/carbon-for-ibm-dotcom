...
const template = (props?) => {
  ...
  return html`
    <dds-footer-nav-item title-text="${ifNonNull(titleText)}"></dds-footer-nav-item>
  `;
};
...
describe('dds-footer-nav-item', function() {
  describe('Misc attributes', function() {
    it('should render with minimum attributes', async function() {
      ...
      expect(document.body.querySelector('dds-footer-nav-item')).toMatchSnapshot({ mode: 'shadow' });
    });
