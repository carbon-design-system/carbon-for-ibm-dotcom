...
export const contentBlockSegmentedItems = (
  <>
    <DDSContentBlockSegmentedItem>
      <DDSContentGroupHeading>A scelerisque purus semper eget duis at tellus. </DDSContentGroupHeading>
      <DDSContentItemCopy>
...
export const universalBanner = srcImage => (
  <DDSUniversalBanner image-width="4-col">
    <DDSUniversalBannerImage slot="image" default-src={srcImage}></DDSUniversalBannerImage>
...
export const cardGroupItems = (
  <DDSCardGroupItem href="https://example.com">
    <DDSImage slot="image" alt="Image alt text" default-src={imgXlg4x3}></DDSImage>
...
export const contentLeadspace = (
  <DDSLeadspace size="medium" gradient-style-scheme="true" alt="" default-src={leadspaceImg}>
...
export const contentLeadspaceSearch = (
  <DDSLeadspaceWithSearch adjacent-theme="white-and-g10" scroll-behavior>
    ...
    <DDSSearchWithTypeahead slot="search" leadspace-search active should-remain-open></DDSSearchWithTypeahead>
...
export const tocContent = (
  <>
    <DDSLeadspaceBlock name="1" data-title="Lorem ipsum dolor sit amet">
      <DDSLeadspaceBlockHeading>Lorem ipsum dolor sit amet</DDSLeadspaceBlockHeading>
      <DDSLeadspaceBlockContent>
        <DDSContentBlockHeading>Consectetur adipiscing elit, sed do eiusmod tempor incididunt ut.</DDSContentBlockHeading>
    ...
    <DDSContentBlockSegmented name="2" data-title="Pharetra pharetra massa massa ultricies mi quis.">
      <DDSContentBlockHeading>Pharetra pharetra massa massa ultricies mi quis.</DDSContentBlockHeading>
    ...
    <DDSFeatureCard size="large" href="https://example.com">
      <DDSImage slot="image" alt="Image alt text" default-src={imgLg1x1}>
        <DDSImageItem media="(min-width: 991px)" srcset={imgLg1x1}></DDSImageItem>
      </DDSImage>
    ...
    <DDSContentBlockSegmented name="3" data-title="Elementum nibh tellus molestie nunc non.">
      <DDSContentBlockHeading>Elementum nibh tellus molestie nunc non.</DDSContentBlockHeading>
    ...
    <DDSCalloutWithMedia>
      <DDSContentBlockHeading slot="heading">Mauris ultrices eros in cursus</DDSContentBlockHeading>
      <DDSCalloutWithMediaCopy size="sm">
        Porttitor eget dolor morbi non arcu. Et ligula ullamcorper malesuada proin libero nunc consequat. In est ante in nibh
        mauris cursus mattis. Turpis tincidunt id aliquet risus feugiat in. Vel facilisis volutpat est velit egestas dui.
    ...
    <DDSLogoGrid name="5" data-title="Lobortis elementum nibh tellus" hide-border="true">
      <DDSContentBlockHeading>Lobortis elementum nibh tellus</DDSContentBlockHeading>
    ...
    <DDSContentBlockCards name="6" data-title="Aliquam condimentum interdum">
      <DDSContentBlockHeading>Aliquam condimentum interdum</DDSContentBlockHeading>
      <DDSCardGroup>{Array.from([1, 2, 3]).map(() => cardGroupItems)}</DDSCardGroup>
    ...
    <DDSCTABlock name="7" data-title="Duis aute irure dolor in reprehenderit" no-border>
      ...
      <DDSCTABlockItemRow no-border>
        ...
        <DDSCTABlockItem>
          ...
          <DDSContentItemCopy>IBM DevOps partners have a wide range of expertise</DDSContentItemCopy>
          <DDSTextCTA slot="footer" cta-type="local" icon-placement="right" href="example.com">
            Browse tutorials
          </DDSTextCTA>
        </DDSCTABlockItem>
...
export const StoryContentNoToC = () => (
  <div className="dds-ce-demo-devenv--ui-shell-content" style={{ paddingRight: '1rem' }}>
