...
[![Edit @carbon/ibmdotcom-web-components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://stackblitz.com/github/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/web-components/examples/codesandbox/components/tabs-extended-media)
  ...
  <c4d-tab label="First tab">
    <c4d-content-item-horizontal-media align="right">
      ...
      <c4d-content-item-horizontal-copy
        ...
        elit sollicitudin.</c4d-content-item-horizontal-copy
      >
...
| --------------------------- | ---------------------------------------- | ----------- |
| `<c4d-tabs-extended-media>` | `data-autoid="cds--tabs-extended-media"` | Component   |
