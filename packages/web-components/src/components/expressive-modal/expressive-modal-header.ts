...
import { BXModalHeaderBase } from '@carbon/web-components/es/components/modal/modal-header.js';
...
class DDSExpressiveModalHeader extends StableSelectorMixin(BXModalHeaderBase) {
