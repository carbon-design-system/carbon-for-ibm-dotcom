...
[![Edit @carbon/ibmdotcom-web-components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://stackblitz.com/github/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/web-components/examples/codesandbox/components/expressive-modal)
...
<c4d-expressive-modal open>
  ...
  <c4d-expressive-modal-footer slot="footer">
    <c4d-button-expressive kind="primary">
      Lorem ipsum dolor
      <svg
        slot="icon"
        focusable="false"
...
```html
<c4d-button-expressive id="my-btn">Open modal</c4d-button-expressive>
