...
import { html, property, internalProperty, query, LitElement, TemplateResult, SVGTemplateResult } from 'lit-element';
...
if (!customElements.get(`${ddsPrefix}-expressive-modal`)) {
  customElements.define(`${ddsPrefix}-expressive-modal`, DDSExpressiveModal);
}
