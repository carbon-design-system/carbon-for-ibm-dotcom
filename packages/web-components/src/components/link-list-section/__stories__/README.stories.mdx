...
[![Edit @carbon/ibmdotcom-web-components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://stackblitz.com/github/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/web-components/examples/codesandbox/components/link-list-section)
...
| ------------------------- | ------------------------------------ | ----------- |
| `<c4d-link-list-section>` | data-autoid="cds--link-list-section" | Component   |
