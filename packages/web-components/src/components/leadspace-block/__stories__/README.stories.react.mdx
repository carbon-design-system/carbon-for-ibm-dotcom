...
| ------------------------------- | ---------------------- | ----------- |
| `<cds-leadspace-block>`         | N/A                    | Component   |
| `<cds-leadspace-block-content>` | N/A                    | Component   |
| `<cds-leadspace-block-cta>`     | N/A                    | Component   |
| `<cds-leadspace-block-heading>` | N/A                    | Component   |
| `<cds-leadspace-block-media>`   | N/A                    | Component   |
