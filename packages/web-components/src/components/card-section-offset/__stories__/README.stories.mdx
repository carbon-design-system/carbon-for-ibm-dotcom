...
<cds-card-section-offset>
  ...
  <cds-card-group slot="card-group" cards-per-row="2">
    <cds-card-group-item empty></cds-card-group-item>
    <cds-card-group-item href="https://example.com">
      <cds-card-eyebrow>Label</cds-card-eyebrow>
      <cds-card-heading
        >Lorem ipsum dolor sit amet, pro graeco tibique an</cds-card-heading
      >
      <p>
...
| --------------------------- | ---------------------------------------- | ----------- |
| `<cds-card-section-offset>` | `data-autoid="cds--card-section-offset"` | Component   |
