...
# Countdown
The countdown component will present a countdown to a target date and time. The target
date can be passed along as a date time string that is
...
## `<caem-countdown>` attributes, properties, and events
<Props of="caem-countdown" />
