...
> 💡 Check our
> [CodeSandbox](https://githubbox.com/carbon-design-system/carbon-for-ibm-dotcom/tree/master/packages/react/examples/codesandbox/components/Layout)
...
```html
<div class="bx--grid bx--layout--top-layout-03 bx--layout--bottom-layout-06">
  <div class="bx--row">
    <div class="bx--layout-1-3">
      <div class="bx--layout--sticky" style="top:50px;">
