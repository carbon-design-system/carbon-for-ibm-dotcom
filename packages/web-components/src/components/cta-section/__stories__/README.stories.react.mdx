...
> 💡 Check our
> [CodeSandbox](https://githubbox.com/carbon-design-system/carbon-for-ibm-dotcom/tree/v1/packages/web-components/examples/codesandbox/components-react/cta-section)
> example implementation.

[![Edit @carbon/ibmdotcom-web-components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://githubbox.com/carbon-design-system/carbon-for-ibm-dotcom/tree/v1/packages/web-components/examples/codesandbox/components-react/cta-section)
  ...
  return (
    <DDSCTASection>
      ...
      <DDSCTABlock>
        ...
        <DDSCTABlockItemRow _noBorder>
          <DDSCTABlockItem>
            <DDSVideoPlayerContainer video-id="0_ibuqxqbe" aspect-ratio="4x3" playing-mode="lightbox" slot="media" hide-caption/>
            <DDSContentItemHeading>Get connected</DDSContentItemHeading>
            <DDSContentItemCopy>IBM DevOps partners have a wide range of expertise. Find one to build that right solution for you.</DDSContentItemCopy>
            <DDSTextCTA slot="footer" cta-type="local" icon-placement="right" href="https://www.example.com">Find a partner</DDSTextCTA>
          </DDSCTABlockItem>
