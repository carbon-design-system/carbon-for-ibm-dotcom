...
> [![Edit @carbon/ibmdotcom-web-components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://stackblitz.com/github/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/web-components/examples/codesandbox/components/cta-section)
...
| ----------------------- | -------------------------------- | ----------- |
| `<c4d-cta-section>`     | `data-autoid="cds--cta-section"` | Component   |
