...
`<dds-cta-section>` has changed. Be sure to update to the latest version of CTA
    ...
    <dds-cta-block-item-row no-border>
      <dds-cta-block-item>
        <dds-video-player-container
          ...
          slot="media"
          hide-caption></dds-video-player-container>
        <dds-content-item-heading>Get connected</dds-content-item-heading>
        <dds-content-item-copy
          >IBM DevOps partners have a wide range of expertise. Find one to build
          that right solution for you.</dds-content-item-copy
      ...
      <dds-cta-block-item>
        ...
        <dds-lightbox-video-player-container
          playing-mode="lightbox"></dds-lightbox-video-player-container>
        <dds-content-item-heading>Learn how</dds-content-item-heading>
        <dds-content-item-copy
          >Dig into more self-directed learning about DevOps
          methodologies.</dds-content-item-copy
