...
> 💡 Check our
> [CodeSandbox](https://stackblitz.com/github/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/web-components/examples/codesandbox/components-react/lightbox-media-viewer)
> example implementation.

[![Edit @carbon/ibmdotcom-web-components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://stackblitz.com/github/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/web-components/examples/codesandbox/components-react/lightbox-media-viewer)
...
| ------------------------------------------------------ | ---------------------------------------------------------- | ----------- |
| `<c4d-expressive-modal>`                               | `data-autoid="cds--expressive-modal"`                      | Component   |
| `::part(title)` in `<c4d-lightbox-media-viewer>`       | `data-autoid="cds--Lightbox-media-viewer__content__title"` | Interactive |
| `::part(description)` in `<c4d-lightbox-media-viewer>` | `data-autoid="cds--Lightbox-media-viewer__content__desc"`  | Interactive |
