...
if (!customElements.get(`${ddsPrefix}-lightbox-video-player-composite`)) {
  customElements.define(`${ddsPrefix}-lightbox-video-player-composite`, DDSLightboxVideoPlayerComposite);
}
