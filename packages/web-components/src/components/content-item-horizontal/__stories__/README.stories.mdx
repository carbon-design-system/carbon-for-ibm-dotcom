...
```html
<cds-content-item-horizontal>
  <cds-content-item-horizontal-eyebrow
    >Lorem ipsum</cds-content-item-horizontal-eyebrow
  >
  <cds-content-item-heading>Aliquam condimentum</cds-content-item-heading>
  <cds-content-item-horizontal-copy
    ...
    sollicitudin.</cds-content-item-horizontal-copy
  >
...
```html
<cds-content-item-horizontal thumbnail>
  <cds-content-item-heading> Aliquam condimentum </cds-content-item-heading>
  <cds-content-item-horizontal-thumbnail-copy>
    Lorem ipsum dolor sit amet, _consectetur_ adipiscing elit. Aenean et
    ultricies est. Mauris iaculis eget dolor nec hendrerit. Phasellus at elit
    sollicitudin.
  </cds-content-item-horizontal-thumbnail-copy>
...
```html
<cds-content-item-horizontal-media align="right">
  ...
  <cds-content-item-horizontal-media-copy
    >Lorem Ipsum</cds-content-item-horizontal-media-copy
  >
  <cds-link-list slot="footer" type="vertical">
    <cds-link-list-item-cta
      icon-placement="right"
...
</cds-content-item-horizontal-media>
```
...
```html
<cds-content-item-horizontal-media align="right">
  <cds-content-item-horizontal-media-video
    video-id="0_ibuqxqbe"></cds-content-item-horizontal-media-video>
  <cds-content-item-heading>Lorem Ipsum</cds-content-item-heading>
  <cds-content-item-horizontal-media-copy
    >Lorem Ipsum</cds-content-item-horizontal-media-copy
  >
