...
> 💡 Check our
> [CodeSandbox](https://stackblitz.com/github/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/web-components/examples/codesandbox/components-react/content-item-horizontal)
> example implementation.

[![Edit @carbon/ibmdotcom-web-components](https://developer.stackblitz.com/img/open_in_stackblitz.svg)](https://stackblitz.com/github/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/web-components/examples/codesandbox/components-react/content-item-horizontal)
...
| `<c4d-content-item-horizontal-eyebrow>`        | `data-autoid="cds--content-item-horizontal-eyebrow"`        | Component   |
| `<c4d-content-item-horizontal-media>`          | `data-autoid="cds--content-item-horizontal-media"`          | Component   |
| `<c4d-content-item-horizontal-media-copy>`     | `data-autoid="cds--content-item-horizontal-media-copy"`     | Component   |
| `<c4d-content-item-horizontal-media-video>`    | `data-autoid="cds--content-item-horizontal-media-video"`    | Component   |
| `<c4d-content-item-horizontal-media-featured>` | `data-autoid="cds--content-item-horizontal-media-featured"` | Component   |
| `<c4d-content-item-horizontal-thumbnail-copy>` | `data-autoid="cds--content-item-horizontal-thumbnail-copy"` | Component   |
