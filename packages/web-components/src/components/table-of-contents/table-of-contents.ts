...
import { html, property, internalProperty, query, queryAll, LitElement } from 'lit-element';
...
if (!customElements.get(`${ddsPrefix}-table-of-contents`)) {
  customElements.define(`${ddsPrefix}-table-of-contents`, DDSTableOfContents);
}
