...
[![Edit @carbon/ibmdotcom-web-components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://stackblitz.com/github/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/web-components/examples/codesandbox/components/content-block-cards)
...
| ----------------------------- | -------------------------------------------- | ----------- |
| `<c4d-content-block-cards>`   | `data-autoid="cds--content-block-cards"`     | Component   |
| `<c4d-content-block-heading>` | `data-autoid="cds--content-block__heading"f` | Component   |
