...
[![Edit @carbon/ibmdotcom-web-components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://stackblitz.com/github/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/web-components/examples/codesandbox/components-react/leadspace)
  ...
  return (
    <C4DLeadspace size="tall">
      ...
      <C4DVideoCTAContainer slot="action">
        <C4DButtonGroup slot="action">
          <C4DButtonCTA cta-type="video" href="0_ibuqxqbe">
            <ArrowRight20 slot="icon" />
            Button 1
          </C4DButtonCTA>
          <C4DButtonGroupItem href="https://www.example.com">
