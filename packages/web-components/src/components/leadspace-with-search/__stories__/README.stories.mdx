...
import '@carbon/ibmdotcom-web-components/es/components/background-media/index';
```

<Description markdown={`${cdnJs({ components: ['leadspace-with-search', 'background-media'] })}`} />
