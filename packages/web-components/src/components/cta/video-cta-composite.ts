...
import { html, property, internalProperty, LitElement } from 'lit-element';
...
if (!customElements.get(`${ddsPrefix}-video-cta-composite`)) {
  customElements.define(`${ddsPrefix}-video-cta-composite`, DDSVideoCTAComposite);
}
