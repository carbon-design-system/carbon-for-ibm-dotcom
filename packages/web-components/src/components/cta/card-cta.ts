...
console.warn(
  `The dds-card-cta component has been deprecated. All its features have been absorbed into 
  the base dds-card component. See migration guide for more information.`
);
