...
```html
<dds-video-player-container id="my-video" video-id="0_ibuqxqbe"> </dds-video-player-container>
```
...
```html
<dds-video-player-container video-id="0_ibuqxqbe" aspect-ratio="16x9" playing-mode="lightbox"></dds-video-player-container>
