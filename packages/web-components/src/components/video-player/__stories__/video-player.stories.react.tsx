...
export const aspectRatio1x1 = ({ aspectRatio, caption, hideCaption, thumbnail, videoId }) => {
  return (
    <DDSVideoPlayerContainer
...
export const aspectRatio4x3 = ({ aspectRatio, caption, hideCaption, thumbnail, videoId }) => {
  return (
    <DDSVideoPlayerContainer
      aspectRatio={aspectRatio}
      caption={caption}
...
export const withLightboxMediaViewer = ({ aspectRatio, caption, hideCaption, thumbnail, videoId, customVideoDescription }) => {
  return (
    <>
      <DDSVideoPlayerContainer
        aspectRatio={aspectRatio}
