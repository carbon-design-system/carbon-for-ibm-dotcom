...
>
> 💡 Check our
> [CodeSandbox](https://stackblitz.com/github/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/web-components/examples/codesandbox/components-react/content-group-cards)
> example implementation.

[![Edit @carbon/ibmdotcom-web-components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://stackblitz.com/github/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/web-components/examples/codesandbox/components-react/content-group-cards)
...
| -------------------------------- | --------------------------------------------- | ----------- |
| `<c4d-content-group-cards>`      | `data-autoid="cds--content-group-cards"`      | Component   |
| `<c4d-content-group-heading>`    | `data-autoid="cds--content-group__title"`     | Component   |
| `<c4d-content-group-cards-item>` | `data-autoid="cds--content-group-cards-item"` | Component   |
