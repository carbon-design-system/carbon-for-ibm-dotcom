...
<dds-content-block-simple>
  ...
  <dds-text-cta slot="footer" href="https://www.ibm.com/" cta-type="local">Lorem ipsum dolor sit amet</dds-text-cta>
</dds-content-block-simple>
```
...
<dds-content-block-simple>
  ...
  <dds-link-list type="default" slot="complementary">
      ...
      <dds-link-list-item-card-cta href="${ifDefined(href)}" cta-type="external">
