...
[![Edit @carbon/ibmdotcom-web-components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://stackblitz.com/github/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/web-components/examples/codesandbox/components/content-block-simple)
...
// with link list
import '@carbon/ibmdotcom-web-components/es/components/cta/link-list-item-card.js';
...
<c4d-content-block-simple>
  ...
  <c4d-link-list type="default" slot="complementary">
    ...
    <c4d-link-list-item-card href="${ifDefined(href)}" cta-type="local">
      <p>Containerization A Complete Guide</p>
      <c4d-card-footer></c4d-card-footer>
    </c4d-link-list-item-card>
    <c4d-link-list-item-card href="${ifDefined(href)}" cta-type="external">
...
| ----------------------------- | ------------------------------------------- | ----------- |
| `<c4d-content-block-simple>`  | `data-autoid="cds--content-block-simple"`   | Component   |
| `<c4d-content-block-copy>`    | `data-autoid="cds--content-block__copy"`    | Component   |
| `<c4d-content-block-heading>` | `data-autoid="cds--content-block__heading"` | Component   |
