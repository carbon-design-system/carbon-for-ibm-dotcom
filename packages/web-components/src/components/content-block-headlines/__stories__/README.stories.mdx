...
[![Edit @carbon/ibmdotcom-web-components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://stackblitz.com/github/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/web-components/examples/codesandbox/components/content-block-headlines)
...
| ------------------------------------ | ------------------------------------------------- | ----------- |
| `<c4d-content-block-headlines>`      | `data-autoid="cds--content-block-headlines"`      | Component   |
| `<c4d-content-block-headlines-item>` | `data-autoid="cds--content-block-headlines-item"` | Component   |
