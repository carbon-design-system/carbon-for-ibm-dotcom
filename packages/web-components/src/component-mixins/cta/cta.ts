...
import Download20 from '@carbon/carbon-web-components/es/icons/download/20.js';
import Launch20 from '@carbon/carbon-web-components/es/icons/launch/20.js';
import PlayOutline20 from '@carbon/carbon-web-components/es/icons/play--outline/20.js';
import Blog20 from '@carbon/carbon-web-components/es/icons/blog/20.js';
import DocumentPDF20 from '@carbon/carbon-web-components/es/icons/document--pdf/20.js';
import NewTab20 from '@carbon/carbon-web-components/es/icons/new-tab/20.js';
import Phone20 from '@carbon/carbon-web-components/es/icons/phone/20.js';
import Calendar20 from '@carbon/carbon-web-components/es/icons/calendar/20.js';
import Email20 from '@carbon/carbon-web-components/es/icons/email/20.js';
