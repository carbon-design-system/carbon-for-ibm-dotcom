...
<p align="center">
  <a href="https://github.com/carbon-design-system/carbon-for-ibm-dotcom/blob/v1/packages/carbon-web-components/LICENSE">
...
<iframe
  src="https://codesandbox.io/embed/github/carbon-design-system/carbon-web-components/tree/v1/examples/codesandbox/basic?fontsize=14&hidenavigation=1&theme=light"
