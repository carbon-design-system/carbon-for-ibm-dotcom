...
<iframe
  src="https://codesandbox.io/embed/github/carbon-design-system/carbon-web-components/tree/v1/examples/codesandbox/styling/theme-zoning?fontsize=14&hidenavigation=1&theme=light"
...
<iframe
  src="https://codesandbox.io/embed/github/carbon-design-system/carbon-web-components/tree/v1/examples/codesandbox/rtl?fontsize=14&hidenavigation=1&theme=light"
...
<iframe
  src="https://codesandbox.io/embed/github/carbon-design-system/carbon-web-components/tree/v1/examples/codesandbox/styling/custom-style?fontsize=14&hidenavigation=1&theme=light"
  style={{ width: '100%', height: '500px', border: 'solid rgba(0,0,0,0.1) 1px', boxShadow: 'rgba(0,0,0,0.1) 0 1px 3px 0' }}
  title="carbon-web-components-getting-started"
  sandbox="allow-modals allow-forms allow-popups allow-scripts allow-same-origin"
></iframe>
