    ...
    <cds-table is-sortable>
      ...
      <cds-table-head>
        <cds-table-header-row >
          ...
          <cds-table-header-cell>Attached groups <cds-slug alignment="bottom-left">${content}${actions}</cds-slug></cds-table-header-cell>
    ...
    <cds-table expandable batch-expansion>
      ...
      <cds-table-head>
        <cds-table-header-row selection-name="header">
          <cds-table-header-cell>Name</cds-table-header-cell>
          <cds-table-header-cell>Protocol  <cds-slug alignment="bottom-left">${content}${actions}</cds-slug> </cds-table-header-cell>
          <cds-table-header-cell>Port</cds-table-header-cell>
          <cds-table-header-cell>Rule</cds-table-header-cell>
