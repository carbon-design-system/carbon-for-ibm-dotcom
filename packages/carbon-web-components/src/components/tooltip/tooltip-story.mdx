...
> 💡 Check our
> [CodeSandbox](https://codesandbox.io/s/github/carbon-design-system/carbon-for-ibm-dotcom/tree/v1/packages/carbon-web-components/examples/codesandbox/basic/components/tooltip)
> example implementation.

[![Edit carbon-web-components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/github/carbon-design-system/carbon-for-ibm-dotcom/tree/v1/packages/carbon-web-components/examples/codesandbox/basic/components/tooltip)
