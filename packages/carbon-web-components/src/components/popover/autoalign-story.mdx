...
> 💡 Check our
> [CodeSandbox](https://codesandbox.io/s/github/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/carbon-web-components/examples/codesandbox/basic/components/autoalign)
> example implementation.

[![Edit carbon-web-components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/github/carbon-design-system/carbon-for-ibm-dotcom/tree/main/packages/carbon-web-components/examples/codesandbox/basic/components/autoalign)
...
- pass `cds-slug`'s `id` property value to `cds-slug-callout`'s `triggerId`
  property
- add the `autoalign` property to `cds-slug-callout`
...
<cds-slug-callout triggerId="slug-1" autoalign>
  <div slot="body-text">
