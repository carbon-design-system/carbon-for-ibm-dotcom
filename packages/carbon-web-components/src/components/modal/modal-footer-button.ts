...
import { BXButtonBase } from '../button/button';
import buttonStyles from '../button/button.scss';
import styles from './modal.scss';

const { prefix } = settings;

export class BXModalFooterButtonBase extends BXButtonBase {
...
class BXModalFooterButton extends BXModalFooterButtonBase {}
