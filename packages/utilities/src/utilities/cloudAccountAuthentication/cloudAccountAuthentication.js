...
/**
 * Utility to to determine user login status via cookie or api
 */
class cloudAccountAuthentication {
  /**
  ...
  static async checkAPI() {
    const cloudLogin = await fetch(
      'https://cloud.ibm.com/api/v6/selected-account?profile=true',
      {
        method: 'GET',
        headers: {
...
export default cloudAccountAuthentication;
