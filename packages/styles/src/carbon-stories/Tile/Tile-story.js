...
export const Selectable = () => {
  ...
  return (
    <TileGroup defaultSelected="default-selected" legend="Selectable Tile Group" {...props.group()}>
      <RadioTile value="standard" id="tile-1" labelText="Selectable Tile" {...radioProps}>
        Selectable Tile
      </RadioTile>
      <RadioTile
      ...
      <RadioTile value="selected" labelText="Selectable Tile" id="tile-3" {...radioProps}>
        Selectable Tile
      </RadioTile>
    </TileGroup>
  );
