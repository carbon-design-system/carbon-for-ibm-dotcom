...
import mixin from 'carbon-components/src/globals/js/misc/mixin';
import createComponent from 'carbon-components/src/globals/js/mixins/create-component';
import initComponentBySearch from 'carbon-components/src/globals/js/mixins/init-component-by-search';
import handles from 'carbon-components/src/globals/js/mixins/handles';
