...
function _renderSubnavItem(sections) {
  ...
  return `
    <li class="bx--header__submenu">
      <a aria-haspopup="menu" aria-expanded="false" class="bx--header__menu-item bx--header__menu-title" href="javascript:void(0)" role="menuitem" tabindex="0" aria-label="${sections.title}">
        ${sections.title}
        <svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" width="10" height="6" viewBox="0 0 10 6" aria-hidden="true" class="bx--header__menu-arrow" style="will-change: transform;">
          <path d="M5 6L0 1 .7.3 5 4.6 9.3.3l.7.7z"></path>
        </svg>
      </a>
      <ul aria-label="${sections.title}" class="bx--header__menu" role="menu">
        ${subNavLinks}
      </ul>
    </li>
  `;
