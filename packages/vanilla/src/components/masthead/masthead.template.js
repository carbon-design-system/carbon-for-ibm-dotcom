    ...
    <div class="${prefix}--masthead">
      <div class="${prefix}--masthead__l0">
        <header aria-label="IBM" data-autoid="${stablePrefix}--masthead" class="${prefix}--header" role="banner">
          ...
          <button data-autoid="${stablePrefix}--masthead__hamburger" aria-label="Open menu" class="${prefix}--header__action ${prefix}--header__menu-trigger ${prefix}--header__menu-toggle ${prefix}--header__menu-toggle__hidden" title="Open menu" type="button"><svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" aria-hidden="true" style="will-change: transform;"><path d="M2 14.8h16V16H2zm0-3.6h16v1.2H2zm0-3.6h16v1.2H2zM2 4h16v1.2H2z"></path></svg></button>
