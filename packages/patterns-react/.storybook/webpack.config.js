...
const useCarbonExpressive =
  process.env.PATTERNS_STORYBOOK_CARBON_EXPRESSIVE === 'true';
...
const useExternalCss =
  process.env.PATTERNS_STORYBOOK_USE_EXTERNAL_CSS === 'true';
 ...
 * @type {boolean}
 */
const useStyleSourceMap = process.env.PATTERNS_STORYBOOK_SOURCEMAPS === 'true';

const useControlledStateWithEventListener =
  process.env.PATTERNS_USE_CONTROLLED_STATE_WITH_EVENT_LISTENER === 'true';
 ...
 * @type {boolean}
 */
const useRtl = process.env.PATTERNS_STORYBOOK_USE_RTL === 'true';
